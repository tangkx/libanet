#include "libanet/net/TcpServer.h"
#include "libanet/base/Logging.h"
#include "libanet/net/Acceptor.h"
#include "libanet/net/EventLoop.h"
#include "libanet/net/EventLoopThreadPool.h"
...
: loop_(CHECK_NOTNULL(loop)), ipPort_(listenAddr.toIpPort()), name_(nameArg),
...
void
TcpServer::TcpServer::removeConnectionInLoop(const TcpConnectionPtr &conn) {
	loop_->assertInLoopThread();
	LOG_INFO << "TcpServer::removeConnetionInLoop [" << name_
