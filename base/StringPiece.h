#ifndef LIBANET_BASE_STRINGPIECE_H
#define LIBANET_BASE_STRINGPIECE_H
...
public:
	...
	void set(const void *buff, int len) {
		ptr_ = reinterpret_cast<const char *>(buff);
		length_ = len;
	}
...
std::ostream &operator<<(std::ostream &o, const libanet::StringPiece &piece);
